...
\begin{tabular*}{\linewidth}{lc@{\extracolsep{\fill}}r@{\extracolsep{0pt}}}
 & & HSF-CWP-2017-05 \\
 & & March 25, 2018 \\ % use \date or hardwire e.g. December 15, 2017
 & & \\
\end{tabular*}
\vspace{1.0cm}
...
\author[p]{Martin Ritter}
\author[q]{Eduardo Rodrigues}
\author[l]{Tai Sakuma}
\author[a]{Elizabeth Sexton-Kennedy}
\author[p]{Michael D. Sokoloff}
\author[r]{\\ Carl Vuosalo}
...
\affiliation[p]{Fakultät für Physik, Ludwig-Maximilians-Universität München, München, Germany}
\affiliation[q]{University of Cincinnati, Cincinnati, Ohio, USA}
\affiliation[r]{University of Wisconsin-Madison, Madison, Wisconsin, USA}
\affiliation[s]{University of Washington, Seattle, Washington, USA}
