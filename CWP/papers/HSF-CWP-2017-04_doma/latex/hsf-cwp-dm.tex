...
%
% ^ <briedel@uchicago.edu> 2018-04-09T20:36:43.846Z.
...
% changed to "density gains in current storage technologies." Tape scaling has quite a future but hard drives, less so
% ^.
...
(e.g.,
% * <briedel@uchicago.edu> 2018-04-05T15:43:01.526Z:
%
% > most
% "more" rather than "most"?
%
% ^.
...
% * <briedel@uchicago.edu> 2018-04-05T15:43:37.726Z:
%
% > Volatile data sources would impact many aspects of the system; catalogs, job brokering, monitoring/alerting, accounting, the applications themselves.
% Aren't we dealing with somewhat volatile storage in terms of xrootd caches today already? The file _might_ be there, but it isnt guaranteed.
%
% ^.
...
stability.
% * <briedel@uchicago.edu> 2018-04-05T15:49:15.646Z:
%
% > stability.
% This paragraph begs the question of whether one needs to move to "direct-access-based archives" if the data is only accessed once or twice. The plenty of tape is not that great in that case.
%
% ^.
