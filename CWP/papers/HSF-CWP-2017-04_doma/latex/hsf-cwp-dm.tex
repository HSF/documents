...
\begin{itemize}
\item Row-based vs. column-based
...
\item Can map-reduce, Spark-like
...
\begin{itemize}
\item Impact of concentrating the
  data in fewer, larger locations (``data-lake'' approach)
\item Impact of an increased use of
