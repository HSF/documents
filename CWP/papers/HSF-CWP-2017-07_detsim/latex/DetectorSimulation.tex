...
\abstract{ A working group on detector simulation was formed as part of the HEP 
Software Foundation's initiative to prepare a Community White Paper that describes 
the main software challenges and opportunities to be faced in our field over the next 
...
of a HEP simulation application, including MC truth handling, geometry modeling, particle 
...
and digitisation. The work programme described in this document focuses on the need to 
improve both software and physics performance, in view of the need to improve statistical precision
and to address the diversification of physics programmes.}
