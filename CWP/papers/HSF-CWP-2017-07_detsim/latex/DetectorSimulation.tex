...
\begin{tabular*}{\linewidth}{lc@{\extracolsep{\fill}}r@{\extracolsep{0pt}}}
 & & HSF-CWP-2017-13 \\
 & & January 24, 2018 \\ % use \date or hardwire e.g. December 15, 2017
 & & \\
\end{tabular*}
\vspace{0.1cm}
...
\author[d]{A Ribon}
\author[d]{S Roiser}
\author[o]{D Ruterbories}
\author[f]{S Sekmen}
\author[h]{B Siddi}
\author[f]{E Snider}
\author[g]{S Vallecorsa}
\author[e]{M Verderi}
\author[f]{H Wenzel}
\author[d]{S Wenzel}
\author[d]{B Viren}
\author[f]{T Yang}
\author[f]{L Welty-Rieger}

\vspace{0.5cm}

\affiliation[a]{Brookhaven National Laboratory, Upton NY, USA}
\affiliation[b]{University of Cambridge,Cambridge, UK}
\affiliation[c]{Carleton University, Ottawa, ON, Canada}
\affiliation[d]{CERN, Geneva, Switzerland}
\affiliation[e]{IN2P3-LLR, Ecole Polytechnique, Palaiseau, France}
\affiliation[f]{Fermilab National Accelerator Laboratory, Batavia IL , USA}
\affiliation[g]{Gangneung-Wonju National University, Gangneung, Gangwon-do, South Korea}
\affiliation[h]{Università di Ferrara and INFN Ferrara, Ferrara, Italy}
\affiliation[j]{Lawrence Berkeley National Laboratory, Berkeley CA, USA}
\affiliation[k]{University of Michigan, Ann Arbor MI, USA}
\affiliation[l]{Università di Pisa and INFN Pisa, Pisa, Italy}
\affiliation[m]{University of Pittsburgh, Pittsburgh PA, USA}
\affiliation[n]{Princeton University, Princeton, NJ 08544, USA}
\affiliation[o]{University of Rochester, Rochester NY, USA}
\affiliation[p]{Rutherford Appleton Laboratory, Chilton, UK}
\affiliation[q]{SLAC National Accelerator Laboratory, Menlo Park, CA 94025, USA}
\affiliation[r]{University of Illinois Urbana-Champaign, Champaign IL, USA}
...
is typically modeled with the GENIE ~\cite{}{[}7{]} package, while Geant4 is
...
ProtoDUNE (Cosmic events with Corsika {[}36{]}) & 10 & 180  & 
480 & 25 & 1000 \\ \hline
