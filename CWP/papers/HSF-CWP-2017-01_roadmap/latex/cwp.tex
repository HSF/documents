...
\item Exploit the discovery of the Higgs boson as a precision tool
  ...
  (BSM) physics.
\item
  Etudy the decays of $b$- and $c$-hadrons, and tau leptons, in the search
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        \includegraphics[width=\textwidth]{cms-cpu.png}
        \caption{}
        \label{fig:cms-cpu}
    \end{subfigure}
    \quad
    \begin{subfigure}[b]{0.47\textwidth}
        \includegraphics[width=\textwidth]{cms-disk.png}
        \caption{}
        \label{fig:cms-disk}
    \end{subfigure}
