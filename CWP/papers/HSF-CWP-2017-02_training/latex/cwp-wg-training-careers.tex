...
complexity of algorithmic analysis in HEP require developers 
...
of the most advanced experimental challenges. There is a growing cnsensus in the HEP community 
on the need for training programmes to bring researchers up to date with new software technologies, 
...
A strong research community comprises independent thinkers who ask
...
experiments to adopt the same olutions in an efficient way. 
...
the National Science Foundation (NSF) [Refs 1 and 2].

An important challenge will be to discover incentives that will encourage 
increasing numbers of people to dedicate time and effort to train their colleagues.
...
visibility and recognition is given only to those working on a data analysis project, 
rather othan on the development and support of the underlying software. A possible 
solution to this conundrum could be the establishment of specific career paths 
for researchers specialising in scientific software development. However, the practical 
...
changing forcing developers and physicsts to closely interact during the entire process of
...
important training topics. Additionally, special emphasis should be given to
reporting results and documenting them.
The training subjects considered important to pursue are
listed as follows:
...
MOOCs can be used to develop an open-source set of tutorials and tools. Existing 
online courses such as Udacity and Coursera can be evaluated and recommended to 
the community. A novel approach such as WikiToLearn
...
useful resource for addressing common problems and questions. This approach has already
...
\begin{itemize}
   ...
   \item Their material, made public on a web-site, can be further expanded by collaborators
...
courses) could be of mutual benefit in the development of a complete training 
programme.
...
Software Carpentry (SC) \footnote{\url{https://software-carpentry.org}} and Data
Carpentry (DC) \footnote{\url{http://www.datacarpentry.org}} are two parts of The
...
%\begin{itemize}
%
%   \item How to motivate the community to participate in developing 
programs? Can some of it come from \& leadership?
%   \item How to deal with competitiveness in the field? Can’t force 
people to be interested in forming a community. How can we incentivize this? 
Building a %vibrant, welcoming community may help.
%\end{itemize}
