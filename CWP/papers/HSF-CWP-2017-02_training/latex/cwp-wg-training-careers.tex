...
the necessary learning curve has been kept appropriately shallow. An interesting exercise in
this context has recently been made by colleagues of
the GridKa School of computing: the material from this year (2017) has been made
...
server{\url{https://gitlab.in2p3.fr/MaitresNageurs}}. Taking profit of
the Gitlab ability to host Docker images, those tutorials aims to avoid the
