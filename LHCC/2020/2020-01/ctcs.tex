...
uploaded on arxiv and submitted for publication~\cite{Gen20}.
...
resources~\cite{ALICE-TDR-12, ATLAS-TDR-17, CMS-TDR-7, LHCb-TDR-11, WLCG-CM-Update, ALICE-TDR-019, 
LHCb-TDR-018}
...
and ROOT benefitting the whole HEP software community~\cite{CMS01}. The
...
experiment~\cite{H1Gflash}. This parameterization, available within the
...
produce 35 PB/year of data AOD and 215 PB/year of MC \cite{Ref1}. In
...
experiments and analyses. This new format called RNTuple \cite{Ref9}, an
