...
\\
 & & HSF-TN-2016-03 \\  % ID
 & & January 12, 2017 \\ % Date - Can also hardwire e.g.: 23 March 2010
 & & \\
% not in paper \hline
\end{tabular*}
...
\bibitem{portage} Portage: \url{https://wiki.gentoo.org/wiki/Project:Portage}
\bibitem{prefix} Gentoo Prefix project \url{https://wiki.gentoo.org/wiki/Project:Prefix}
...
\bibitem{gentoo} Gentoo: \url{https://www.gentoo.org/}
